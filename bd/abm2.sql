...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2016 a las 19:36:11
...
(77, '3666666688', '1998-01-02', 'm', 'Peronismo', '3666666688.jpg', '', '');
...
INSERT INTO `producto` (`codigo`, `nombre`, `fecha`, `foto`) VALUES
(1, 'Windows', '', ''),
(2, 'linux', '', ''),
(3, 'ubuntu', '', '');
...
INSERT INTO `usuarios` (`id`, `usuario`, `dni`, `password`, `tipo`, `email`, `pathfoto`) VALUES
(2, 'ramon', 56565, 1111111, 'comp', 'comp@comp', ''),
(4, 'matias', 32935835, 4444, 'admin', 'admin@admin', ''),
(5, 'pedro', 1212, 4545, 'comp', 'comp@comp', ''),
(6, 'florinda', 7878, 7878, 'vend', 'vend@vend', '');
